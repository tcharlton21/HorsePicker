...
with open("../../res/memorialDayWeekend2016TestData/horseAndRaceInfo/5302016.txt", "r") as csvfile:
...
with open('../../res/memorialDayWeekend2016TestData/horseAndRaceInfo/Race_info_5-30-2016.csv', 'w', newline='') as f:
...
with open('../../res/memorialDayWeekend2016TestData/horseAndRaceInfo/Horse_info_5-30-2016.csv', 'w', newline='') as f:
